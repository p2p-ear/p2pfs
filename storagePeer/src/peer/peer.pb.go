...
var fileDescriptor_055ae5a865fc1c9e = []byte{
	...
	,
}
...
type PeerServiceClient interface {
	...
	FindSuccessor(ctx context.Context, in *FindSuccRequest, opts ...grpc.CallOption) (*FindSuccReply, error)
}
...
func (c *peerServiceClient) FindSuccessor(ctx context.Context, in *FindSuccRequest, opts ...grpc.CallOption) (*FindSuccReply, error) {
	out := new(FindSuccReply)
	err := c.cc.Invoke(ctx, "/peer.PeerService/FindSuccessor", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PeerServiceServer interface {
	...
	FindSuccessor(context.Context, *FindSuccRequest) (*FindSuccReply, error)
}
...
func (*UnimplementedPeerServiceServer) FindSuccessor(ctx context.Context, req *FindSuccRequest) (*FindSuccReply, error) {
...
func _PeerService_FindSuccessor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindSuccRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PeerServiceServer).FindSuccessor(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/peer.PeerService/FindSuccessor",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PeerServiceServer).FindSuccessor(ctx, req.(*FindSuccRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _PeerService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PeerService_FindSuccessor_Handler,
		},
	},
