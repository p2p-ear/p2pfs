...
import unittest
import json # for test_registration method in class TestAuthBlueprint
import time # for test_invalid_logout method in class TestAuthBlueprint
...
class TestAuthBlueprint(BaseTestCase):
    ...
    def test_incorrect_password(self):
        """ Test for login with correct email and incorrect password """
        with self.client:
            # user registration
            resp_register = self.register_user('joe@gmail.com', '123456')
            data_register = json.loads(resp_register.data.decode())
            ...
            self.assertTrue(resp_register.content_type == 'application/json')
            self.assertEqual(resp_register.status_code, 201)
            # registered user login with incorrect password
            response = self.login_user('joe@gmail.com', '1234')
            data = json.loads(response.data.decode())
            self.assertTrue(data['status'] == 'fail')
